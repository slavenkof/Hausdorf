...
public class TestSys {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        TestSys test = new TestSys(892213690, new UCGenerator(), new UCGenerator(),
     ...
     * @throws FileNotFoundException
     */
    public TestSys(int Seed, PolGenerator A, PolGenerator B, String[] paths, int[] para) throws FileNotFoundException {
        seed = Seed;
        a = A;
        b = B;
