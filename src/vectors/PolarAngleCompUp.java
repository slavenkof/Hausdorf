...
/**
 * Класс реализует сортировку точек по полярному углу в верхней полуплоскости.
 ...
 *
 */
public class PolarAngleCompUp implements Comparator<Point2D> {
     ...
     */
    public PolarAngleCompUp(Point2D fulcrum) {
